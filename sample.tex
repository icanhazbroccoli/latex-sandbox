...
\begin{frame}{Generalized Quantifier Theory}
  ...
  \footnote{\fn{Barwise \& Cooper, 1980; Keenan \& Stavi 1984}}

\note{clean up slide}
  
  \l{Q student(s) came to the party}

  \Tree [ [ Q [.A student(s) ] ] \qroof{came to the party}.{B} ] 
...
\only<3>{
    ...
    {\bf Big research question:} \\ Which of these are realised in NL?
...
(14) \l{Every {\bf two} houses come with one parking space.}
  
\end{frame}

\begin{frame}{Numerals are not quantifiers}

  (15) \l{Rod A is {\bf three} times longer than rod B.}

\note{The most natural way of looking at this example does not involve cardinality. Take a length and multiply it by 3. }
  
  (16) \l{{\bf Two} is a Fibonacci number.}
...
\only<3>{
  ...
  (15') \l{Rod A is longer than rod B.}
...
\begin{itemize}
\item[] \hspace*{-1.5em} \textbullet \  We seem to be committed to a domain of abstract entities
\item[] \hspace*{-1.5em}  \textbullet \  We don't have to be: 
\begin{itemize}
\item[] \hspace*{-2em} -   Cresswell 1977: \l{tall} involves an ability to decide that $j$ $<$ $m$
\item[] \hspace*{-2em} -   We can see degrees as equivalence classes of individuals 
\end{itemize}
\end{itemize}
...
\begin{itemize}
\item[] \hspace*{-1.5em} \textbullet \ This is an ordinal scale 
\item[] \hspace*{-1.5em} \textbullet \  No distances, no zero, no multiplication
\item[] \hspace*{-1.5em} \textbullet \  Height etc. would need to be added to the equivalence classes \fn{(Bale 2011)}
\item \hspace*{-1.5em} \textbullet \  Back to square one 
\end{itemize}
...
In the absence of a determiner, it's parallel to a bare plural:
        ...
        (21) \l{American students came to the party}
      ...
      \begin{frame}[t]{The modifier view: challenges}
        ...
        (16) \l{{\bf Two} is a Fibonacci number} \pause

        This is not NP ellipsis:

        (16') *\l{{\bf Two} are a fibonacci number}

        (16'') \l{{\bf Two} boxes are/*is open} 
